...
var configs = (function () {
    ...
    Singleton.defaultOptions = {
        ...
        user: "guest",
        textDwonload : "link ",
        linkDownload: "https://www.Link.com/",
        download_help: "Generates an Link",
        bio_help: "Little about me",
        printText: "prints your bio",
        is_root: false,
        type_delay: 0
    };
    return {
...
var files = (function () {
    ...
    Singleton.defaultOptions = {
        "about.txt": "My name is Amirhossein Mortezaie.\n My career starts back in 2006, since then im working in opensource industry.\nCurrently im working in most successful digital payment company in country\nplease feel free to download my resume by typing download in terminal",
...
var main = (function () {
    ...
    var cmds = {
        ...
        DOWNLOAD: { value: "download", help: configs.getInstance().download_help },
    ...
    Terminal.prototype.handleCmd = function () {
        ...
        switch (cmdComponents[0]) {
            ...
            case cmds.CLEAR.value:
                this.clear();
                break;
            case cmds.JUSTENTER.value: // missed
                this.unlock();
                break;
    ...
    Terminal.prototype.download = function (cmdComponents) {
        var result = configs.getInstance().textDwonload + ": " + configs.getInstance().linkDownload;
        this.type(result, this.unlock.bind(this));
    };

    Terminal.prototype.bio = function (cmdComponents) {
        var result = configs.getInstance().printText;
        this.type(result, this.unlock.bind(this));
    };
